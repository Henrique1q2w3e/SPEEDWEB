  ...
  return (
    <group rotation={[0.3, 0.5, 0]}>
      <mesh ref={ringA} rotation={[Math.PI / 2.4, 0, 0]}>
        ...
        <meshStandardMaterial color="#c9a24b" metalness={1} roughness={0.2} envMapIntensity={1.2} />
      </mesh>
      <mesh ref={ringB} rotation={[0, Math.PI / 2.4, Math.PI / 5]}>
        <torusGeometry args={[0.85, 0.055, 24, 120]} />
        <meshStandardMaterial color="#ddc07c" metalness={1} roughness={0.25} envMapIntensity={1.2} />
      </mesh>
    </group>
  );
}
